trigger CPBrokerageTrigger on CP_Brokerage__c (before update, after insert, after update, before insert) {
    ...
    if(Trigger.isAfter && Trigger.isUpdate){
        ...
        //Added by Prashant to sync CP Brokerage entities with BI. /// 26-02-26..START
        CPBrokerageTriggerHandler.syncChildInvoices(Trigger.new, Trigger.oldMap);
        //Added by Prashant to sync CP Brokerage entities with BI. /// 26-02-26..END
        for(CP_Brokerage__c cpl : trigger.new){
