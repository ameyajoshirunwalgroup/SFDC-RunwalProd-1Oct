...
{         
   ...
   RWCaseTriggerHandler obj = new RWCaseTriggerHandler();
    ...
    if(Trigger.isUpdate && Trigger.isAfter){
        ...
        List<Id> closedCaseIds = new List<Id>(); //Added by Vinay 20-01-2026
        for(Case c: trigger.new){   
        ...
        if(closedCaseIds.size() > 0){ //Added by Vinay 20-01-2026
            // LockatedApp_Notifications.caseClosedNotification(closedCaseIds);
        }
