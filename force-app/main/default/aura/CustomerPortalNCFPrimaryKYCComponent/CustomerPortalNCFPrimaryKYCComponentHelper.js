({
    ...
    getuploadedFiles:function(component,event){
        ...
        action.setParams({  
           "bookingId":component.get("v.bookingId"),"applicantNumber":'Primary Applicant'
        });  
            ...
            if(state=='SUCCESS'){  
                ...
                if(result.length ==0)
                {
                    ...
                    else
                    {
                        ...
                        if(component.get("v.applicantDetail.Subtype_Of_Applicant__c") == 'Indian National' && component.get("v.applicantDetail.Address_Proof_Document__c") != undefined )
                        component.set("v.disableOtherDocumentUpload", false);
                        else if(component.get("v.applicantDetail.Subtype_Of_Applicant__c") == 'Foreign Nationals Of Indian Origin' && component.get("v.applicantDetail.Type_Of_Origin__c") != undefined )
                        component.set("v.disableOtherDocumentUpload", false);
                        else if(component.get("v.applicantDetail.Subtype_Of_Applicant__c") == 'Foreign Nationals Of Indian Origin' && component.get("v.applicantDetail.PassportNoDetails__c") != undefined )
                        component.set("v.disablePassportUpload", false);
                        else if(component.get("v.applicantDetail.Subtype_Of_Applicant__c") == 'For NRI' && component.get("v.applicantDetail.PassportNoDetails__c") != undefined )
                         component.set("v.disableOtherDocumentUpload", false);
                        else if((component.get("v.applicantDetail.Subtype_Of_Applicant__c") == 'For Company' || component.get("v.applicantDetail.Subtype_Of_Applicant__c") == 'Partnership Firm' ) && component.get("v.applicantDetail.Pan_Card_Number_of_Authority_Signatory__c") != undefined  )
                          component.set("v.disableOtherDocumentUpload", false);
                   //component.set("v.disableOtherDocumentUpload", false); 
                        component.set("v.Spinner", false);
                    }
