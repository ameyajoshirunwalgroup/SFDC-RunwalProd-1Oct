({
    doInit : function(component, event, helper){  
        ...
        var action = component.get("c.getTDSRecord");
        action.setParams({ "TDSId":component.get("v.recordId")});
        action.setCallback(this, function(response) 
                           {
                               ...
                               if (state === "SUCCESS") 
                               {
                                   ...
                                   if(responsevalues.RW_TDS_Document_ID__c)
                                   {
                                       component.set("v.SanctionId",responsevalues.RW_TDS_Document_ID__c);
    ...
    sanctionUploadFinished : function(component, event, helper) {  
        ...
        details['tdsId'] = component.get("v.recordId");  
