({
    doInit : function(component, event, helper) { 
        console.log('bookingId'+component.get("v.bookingId"));
         var residential = component.get("v.applicantDetail.applicantType");
        var residentialMap = component.get("v.ResidentialPicklist");

        if(residential != null && residentialMap != null){
            component.set("v.ResidentialPicklistOptions",residentialMap.pickListMap[residential]);
        } 
        
      if(component.get("v.applicantDetail.applicantType") !='' && component.get("v.applicantDetail.applicantType") != undefined)
            component.set("v.bDisabledDependentFld",false);
        
        if(component.get("v.applicantDetail.residentialStatus") !='' && component.get("v.applicantDetail.residentialStatus") != undefined)
        {
            component.set("v.bDisabledSubDependentFld",false);
            if(component.get("v.applicantDetail.residentialStatus") == 'Foreign Nationals Of Indian Origin' && component.get("v.applicantDetail.passportnodetails") != '' && component.get("v.applicantDetail.passportnodetails") != undefined)
        ...
        component.set('v.columns', [
            ...
            debugger;
            component.set("v.applicantDetail.residentialStatus",'');
            component.set("v.applicantDetail.typeOfOrigin","");
            component.set("v.applicantDetail.addressproofDocument","");
            component.set("v.applicantDetail.addressproofDocumentNumber","");
            component.set("v.applicantDetail.origindetails","");
            component.set("v.applicantDetail.panCardNumberofAuthoritySignatory","");
            component.set("v.applicantDetail.passportnodetails","");
            component.set("v.applicantDetail.panCard","");
 ...
 component.set("v.bDisabledSubDependentFld" , true); 
    ...
    onSubControllerFieldChange : function(component, event, helper) {     
        ...
        else
        {
            ...
            component.set("v.applicantDetail.residentialStatus",controllerValueKey); 
            var compEvent = component.getEvent("DocumentNumberValidate");
        ...
        uploadDocument:   function(component, event, helper) {  
            ...
            details['documentId'] = uploadedFiles[0].documentId;
             details['applicantType'] = component.get("v.applicantDetail.applicantType");
            if(component.get("v.applicantDetail.opportunityId") != undefined && component.get("v.applicantDetail.opportunityId") !='')
            details['oppRecId'] = component.get("v.applicantDetail.opportunityId");
            if(component.get("v.applicantDetail.applicantId") != undefined && component.get("v.applicantDetail.applicantId") !='')
            details['applicantId'] = component.get("v.applicantDetail.applicantId");
                details['residentialStatus'] = component.get("v.applicantDetail.residentialStatus");
                 details['documentType'] = event.getSource().get("v.name");
            details['ApplicantNumber'] = component.get("v.applicantDetail.appNumber");
            //details['documentNumber'] = component.find(event.getSource().get("v.name")).get("v.value");
 	 		details['bookingId'] = component.get("v.applicantDetail.bookingId");         
    ...
    validateOtherDocument: function(component,event,helper)
{
    ...
    var localid =event.getSource().getLocalId();
    var inputCmp =component.find(localid);
    if(component.get("v.applicantDetail.addressproofDocument")!= '')
    {
        if(event.getSource().get("v.value") != '' && event.getSource().get("v.value") != null && event.getSource().get("v.value") != undefined)
        {
            if(component.get("v.applicantDetail.addressproofDocument")== 'Aadhar Card')
            {
                ...
                {
                    inputCmp.setCustomValidity("");
                    component.set("v.applicantDetail.addressproofDocumentNumber",event.getSource().get("v.value"));
            ...
            if(component.get("v.applicantDetail.addressproofDocument")== 'Driving License')
            {
                //component.set("v.EOIWrap.RWDocumentNumber",event.getSource().get("v.value"));
                var disableOtherDocumentUpload;
            ...
            if(component.get("v.applicantDetail.addressproofDocument")== 'Electricity Bill')
            {
                component.set("v.applicantDetail.addressproofDocumentNumber",event.getSource().get("v.value"));
                var disableOtherDocumentUpload;
                for(var i=0 ; i<component.get("v.data").length; i++)
            ...
            if(component.get("v.applicantDetail.addressproofDocument")== "Voter’s ID Card")
            {
                component.set("v.applicantDetail.addressproofDocumentNumber",event.getSource().get("v.value"));
                var disableOtherDocumentUpload;
                for(var i=0 ; i<component.get("v.data").length; i++)
            ...
            if(component.get("v.applicantDetail.addressproofDocument")== 'Passport')
            {
                var returnValue = helper.validatePassportNumber(component,event);
                if(returnValue == true)
                {
                    inputCmp.setCustomValidity("");
                    component.set("v.applicantDetail.passportnodetails",event.getSource().get("v.value"));
                    //component.set("v.EOIWrap.RWDocumentNumber",event.getSource().get("v.value"));
                    var compEvent = component.getEvent("DocumentNumberValidate");
                    compEvent.setParams({"IsValid": true });
                    compEvent.fire();
...
/* var compEvent = component.getEvent("DocumentNumberValidate");
    ...
    {
        component.set("v.disableOtherDocumentUpload", true);
        component.set("v.v.applicantDetail.addressproofDocumentNumber","");
        component.set("v.applicantDetail.origindetails","");
            //component.find("DocumentDetails").set("v.disabled",true);
        //component.find("OriginDetails").set("v.disabled",true);
    }
    ...
    onOriginDetailsChange: function (component, event) 
{
    if(event.getSource().get("v.value") != '' && event.getSource().get("v.value") != null && event.getSource().get("v.value") != undefined)
    {
        if(component.get("v.applicantDetail.typeOfOrigin")== 'PIO card')
        {
        ...
        if(component.get("v.applicantDetail.typeOfOrigin")== 'OCI card')
        {
