...
import getOpps from '@salesforce/apex/CPBookingController.getCpMandateInvoice';
...
export default class CpMandateInvoiceList extends NavigationMixin(LightningElement) {
    @track value;
    @track error;
    @track data;
    ...
    callRowAction(event) {
        ...
        if (actionName === 'Generate') {
            ...
            this[NavigationMixin.Navigate]({
                ...
                "attributes": {
                    "url": 'https://cpdesk.runwalgroup.in/apex/CpMandateInvoicePreview?id=' + this.BIId
                }
            });
