...
//import accMobile2 from '@salesforce/schema/Opportunity.Account.RW_Secondary_Mobile_No__pc';
...
import loanData from '@salesforce/apex/CallCustomerController.loanData';
//import accMobile2New from '@salesforce/schema/Opportunity.Account.RW_Secondary_Mobile_No__pc';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';


export default class CallCustomerOnLoan extends LightningElement {
    @api recordId;
    ...
    get mobile1() {
      // alert('Inisde get MObile 1 :: ' + this.recordId);
        //alert('123 closedate:: ' + getFieldValue(this.optyData, accMobile1));
     
        /*if (getFieldValue(this.optyData, accMobile1) != null)
            return getFieldValue(this.optyData, accCountryCode1)+' '+ getFieldValue(this.optyData, accMobile1).replace(getFieldValue(this.optyData, accMobile1).substring(0, 5), 'XXXXX');
        else
            return null;*/
    ...
    get mobile2() {
        ...
        /*if (getFieldValue(this.optyData, accMobile2New) != null)
            return getFieldValue(this.optyData, accCountryCode2)+' '+ getFieldValue(this.optyData, accMobile2New).replace(getFieldValue(this.optyData, accMobile2New).substring(0, 5), 'XXXXX');
        else
            return null;*/
